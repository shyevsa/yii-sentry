...
{
    const MASK = '********';
    const FIELDS_RE = '/(authorization|password|passwd|secret|password_confirmation|card_number|auth_pw|auth_key|security_word|sec_word|security_word_|api_secretword|pass|pass_key|codecolector|Codecollector|pin|kode_reset|kode_verifikasi|api_secret|api_secword|api_secretword_|new_password|old_password|new_password_repeat)/i';
